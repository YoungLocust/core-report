...
public class SFTPUtil {
	 ...
	 */
	public static boolean upload(String fileDirectory, String uploadFile, String orginfilename)
			throws SftpException, IOException {
		SFTPTool sftp = new SFTPTool(Constants.SFTP_REQ_USERNAME, Constants.SFTP_REQ_PASSWORD,
